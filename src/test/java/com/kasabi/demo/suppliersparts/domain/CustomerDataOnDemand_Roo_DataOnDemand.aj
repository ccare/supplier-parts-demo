...
import com.kasabi.demo.suppliersparts.domain.CustomerDataOnDemand;
...
privileged aspect CustomerDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    private AddressDataOnDemand CustomerDataOnDemand.addressDataOnDemand;
    ...
    public void CustomerDataOnDemand.setSurname(Customer obj, int index) {
